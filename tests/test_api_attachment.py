...
from teai_builder.api.server import (
    _FileSizeExceeded,
    _parse_json_content,
    _save_base64_data_url,
    create_app,
)
from teai_builder.utils.document import extract_documents
...
# ---------------------------------------------------------------------------
# extract_documents tests (now in teai_builder.utils.document)
# ---------------------------------------------------------------------------
...
def test_extract_documents_skips_extraction_errors(tmp_path, monkeypatch) -> None:
    ...
    import teai_builder.utils.document as _doc
    monkeypatch.setattr(
        _doc, "extract_text",

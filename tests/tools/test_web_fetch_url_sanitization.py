...
from teai_builder.agent.tools.web import WebFetchTool, _validate_url
...
def _patch_env():
    return patch("teai_builder.security.network.socket.getaddrinfo", _fake_resolve_public), \
           patch("teai_builder.agent.tools.web.httpx.AsyncClient", FakeClient)

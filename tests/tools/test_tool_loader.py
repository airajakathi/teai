...
from teai_builder.agent.tools.loader import _SKIP_MODULES, ToolLoader
...
def test_fs_tool_create_builds_from_context():
    from teai_builder.agent.tools.filesystem import ReadFileTool
...
def test_exec_tool_config_cls():
    from teai_builder.agent.tools.shell import ExecTool, ExecToolConfig
...
def test_web_tools_config_cls():
    from teai_builder.agent.tools.web import WebFetchTool, WebSearchTool, WebToolsConfig
...
def test_web_fetch_tool_create():
    from teai_builder.agent.tools.web import WebFetchTool
    mock_config = MagicMock()
    mock_config.web.enable = True
...
def test_image_gen_tool_config_cls():
    from teai_builder.agent.tools.image_generation import ImageGenerationTool, ImageGenerationToolConfig
...
def test_image_gen_tool_enabled():
    from teai_builder.agent.tools.image_generation import ImageGenerationTool
    mock_config = MagicMock()
...
def test_my_tool_config_cls():
    from teai_builder.agent.tools.self import MyTool, MyToolConfig
...
def test_mcp_wrappers_not_discoverable():
    from teai_builder.agent.tools.mcp import MCPPromptWrapper, MCPResourceWrapper, MCPToolWrapper

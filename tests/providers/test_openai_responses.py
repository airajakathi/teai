...
from teai_builder.providers.openai_responses.converters import (
    convert_messages,
    convert_tools,
    convert_user_message,
    split_tool_call_id,
)
from teai_builder.providers.openai_responses.parsing import (
    consume_sdk_stream,
    consume_sse,
...
class TestParseResponseOutput:
    ...
    def test_malformed_tool_arguments_logged(self):
        ...
        with patch("teai_builder.providers.openai_responses.parsing.logger") as mock_logger:
            result = parse_response_output(resp)

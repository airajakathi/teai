...
def test_feishu_module_import_does_not_import_lark_oapi():
    out = _run_import_probe(
        "import sys; import teai_builder.channels.feishu; print('lark_oapi' in sys.modules)"
    )
...
def test_feishu_channel_constructor_does_not_import_lark_oapi():
    out = _run_import_probe(
        ...
        "from teai_builder.channels.feishu import FeishuChannel; "
...
def test_lark_runtime_thread_import_clears_sdk_import_loop():
    out = _run_import_probe(
        "import asyncio\n"
        "from teai_builder.channels.feishu import _load_lark_runtime\n"
        "async def main():\n"

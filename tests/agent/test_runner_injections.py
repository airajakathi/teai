...
async def test_injection_cycles_capped_at_max():
    ...
    from teai_builder.agent.runner import _MAX_INJECTION_CYCLES, AgentRunner, AgentRunSpec
    from teai_builder.bus.events import InboundMessage
...
async def test_submitted_cron_turn_reports_pending_until_completed(tmp_path):
    ...
    from teai_builder.cron.session_turns import CRON_TRIGGER_META
...
async def test_pending_queue_preserves_overflow_for_next_injection_cycle(tmp_path):
    ...
    from teai_builder.agent.loop import AgentLoop
    from teai_builder.agent.runner import _MAX_INJECTIONS_PER_TURN
    from teai_builder.bus.events import InboundMessage
    from teai_builder.bus.queue import MessageBus
...
async def test_drain_injections_on_empty_final_response():
    ...
    from teai_builder.agent.runner import _MAX_EMPTY_RETRIES, AgentRunner, AgentRunSpec
    from teai_builder.bus.events import InboundMessage

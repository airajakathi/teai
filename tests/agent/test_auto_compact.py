...
from teai_builder.command import CommandContext
...
def _make_fake_compact(
    ...
    *,
    ...
    from teai_builder.session.manager import Session as _Session
...
class TestSessionTTLConfig:
    ...
    def test_session_file_cap_is_internal_constant(self):
        ...
        from teai_builder.session.manager import FILE_MAX_MESSAGES

...
def test_fallback_models_accept_preset_refs_and_inline_configs() -> None:
    from teai_builder.config.schema import Config, InlineFallbackConfig
...
def test_provider_signature_tracks_fallback_presets_and_provider_config() -> None:
    from teai_builder.config.schema import Config
    from teai_builder.providers.factory import provider_signature
...
def test_provider_snapshot_uses_smallest_fallback_context_window() -> None:
    from teai_builder.config.schema import Config
    from teai_builder.providers.factory import build_provider_snapshot

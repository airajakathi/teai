...
from teai_builder.agent.tools import mcp as mcp_runtime
from teai_builder.agent.tools.base import Tool
from teai_builder.agent.tools.mcp import MCPResourceWrapper, MCPToolWrapper
...
async def test_connect_mcp_retries_when_no_servers_connect(tmp_path, monkeypatch: pytest.MonkeyPatch):
    ...
    monkeypatch.setattr("teai_builder.agent.tools.mcp.connect_mcp_servers", _fake_connect)

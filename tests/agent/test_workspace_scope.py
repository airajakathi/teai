...
from teai_builder.agent.tools.cli_apps import CliAppsTool
from teai_builder.agent.tools.filesystem import ReadFileTool
from teai_builder.agent.tools.image_generation import ImageGenerationError, ImageGenerationTool
...
from teai_builder.apps.cli.service import CliAppManager, CliAppsRuntimeConfig
from teai_builder.config.schema import ImageGenerationToolConfig, ProviderConfig
...
async def test_cli_app_scope_controls_working_dir(
    ...
    monkeypatch.setattr("teai_builder.apps.cli.service.get_runtime_subdir", lambda _name: data_dir)
    monkeypatch.setattr(

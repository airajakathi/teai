...
import type { SendImage, SendOptions } from "@/hooks/useTeaiBuilderStream";
...
const SLASH_RECENTS_STORAGE_KEY = "teai_builder.webui.slashCommandRecents";
const SLASH_RECENTS_LIMIT = 5;
const QUEUED_PROMPTS_STORAGE_PREFIX = "teai_builder.webui.composerQueuedGuidance.v1:";
  ...
  return (
    ...
    >
      {goalPanelOpen && canExpandGoal && markdownBody ? (
        <div
          ref={panelRef}
          id="teai_builder-goal-panel-root"
          role="dialog"
          aria-modal="false"
          aria-labelledby="teai_builder-goal-panel-title"
          tabIndex={-1}
          className={cn(
        ...
        >
          <div className="flex shrink-0 items-center justify-between gap-2 border-b border-black/[0.06] px-3 py-2 dark:border-white/[0.08]">
            <h2
              id="teai_builder-goal-panel-title"
          ...
          <div
            id="teai_builder-goal-panel-scroll"
      ...
      >
        ...
        {canExpandGoal ? (
          <button
            ...
            aria-controls={goalPanelOpen ? "teai_builder-goal-panel-root" : undefined}

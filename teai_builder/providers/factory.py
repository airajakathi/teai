...
from teai_builder.config.schema import Config, InlineFallbackConfig, ModelPresetConfig
from teai_builder.providers.base import LLMProvider
from teai_builder.providers.fallback_provider import FallbackProvider
from teai_builder.providers.registry import create_dynamic_spec, find_by_name
...
def _make_provider_core(
    ...
    *,
    ...
    if backend == "openai_codex":
        ...
        from teai_builder.providers.azure_openai_provider import AzureOpenAIProvider
        ...
        from teai_builder.providers.anthropic_provider import AnthropicProvider
        ...
        from teai_builder.providers.bedrock_provider import BedrockProvider

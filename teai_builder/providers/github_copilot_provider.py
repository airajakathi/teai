...
TOKEN_APP_NAME = "teai_builder"
USER_AGENT = "teai_builder/0.1"
...
class GitHubCopilotProvider(OpenAICompatProvider):
    ...
    async def _get_copilot_access_token(self) -> str:
        ...
        if not github_token or not github_token.access:
            raise RuntimeError("GitHub Copilot is not logged in. Run: teai_builder provider login github-copilot")

...
This directory contains built-in skills that extend teai_builder's capabilities.
...
When skills reference large local documentation or logs, prefer teai_builder's built-in

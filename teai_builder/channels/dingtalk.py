...
from teai_builder.security.network import validate_resolved_url, validate_url_target
...
class TeaiBuilderDingTalkHandler(CallbackHandler):
    """
    Standard DingTalk Stream SDK Callback Handler.
    Parses incoming messages and forwards them to the TeaiBuilder channel.
    """
    ...
    async def process(self, message: CallbackMessage):
        ...
        try:
            ...
            # Forward to TeaiBuilder via _on_message (non-blocking).
...
class DingTalkChannel(BaseChannel):
    ...
    async def start(self) -> None:
        ...
        try:
            ...
            handler = TeaiBuilderDingTalkHandler(self)
    ...
    async def _send_markdown_text(self, token: str, chat_id: str, content: str) -> bool:
        return await self._send_batch_message(
            ...
            chat_id,
            "sampleMarkdown",
            {"text": content, "title": "TeaiBuilder Reply"},
        )
    ...
    async def _on_message(
        ...
        """Handle incoming message (called by TeaiBuilderDingTalkHandler).

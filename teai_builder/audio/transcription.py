...
This module owns teai_builder's transcription behavior: config resolution,
...
HTTP details; those live in ``teai_builder.providers.transcription``.
"""
...
from teai_builder.utils.media_decode import FileSizeExceeded, save_base64_data_url

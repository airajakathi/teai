"""On-demand version checker for teai_builder-ai releases.
...
_PYPI_URL = "https://pypi.org/pypi/teai_builder-ai/json"
...
def check_for_update() -> dict[str, Any] | None:
    ...
    return {
        ...
        "pypiUrl": "https://pypi.org/project/teai_builder-ai/",
    }

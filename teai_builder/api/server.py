"""OpenAI-compatible HTTP API server for a fixed teai_builder session.
...
from teai_builder.utils.helpers import safe_filename
...
async def handle_chat_completions(request: web.Request) -> web.Response:
    ...
    model_name: str = request.app.get("model_name", "teai_builder")
...
async def handle_models(request: web.Request) -> web.Response:
    """GET /v1/models"""
    model_name = request.app.get("model_name", "teai_builder")
    return web.json_response(
        {
            "object": "list",
            "data": [
...
def create_app(
    agent_loop, model_name: str = "teai_builder", request_timeout: float = 120.0
) -> web.Application:

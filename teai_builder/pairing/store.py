...
Persistent storage at ``~/.teai_builder/pairing.json`` keeps approved senders
...
from teai_builder.config.paths import get_data_dir
from teai_builder.utils.helpers import _write_text_atomic

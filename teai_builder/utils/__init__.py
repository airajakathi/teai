...
from teai_builder.utils.path import abbreviate_path
...
_LEGACY_MODULE_ALIASES = {
    "webui_thread_disk": "teai_builder.webui.thread_disk",
    "webui_transcript": "teai_builder.webui.transcript",
    "webui_turn_helpers": "teai_builder.session.webui_turns",
}

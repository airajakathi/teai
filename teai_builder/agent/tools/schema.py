"""JSON Schema fragment types: all subclass :class:`~teai_builder.agent.tools.base.Schema` for descriptions and constraints on tool parameters.

- ``to_json_schema()``: returns a dict compatible with :meth:`~teai_builder.agent.tools.base.Schema.validate_json_schema_value` /
  :class:`~teai_builder.agent.tools.base.Tool`.
...
Shared validation and fragment normalization are on the class methods of :class:`~teai_builder.agent.tools.base.Schema`.
...
from teai_builder.agent.tools.base import Schema

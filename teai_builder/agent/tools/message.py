...
from teai_builder.agent.tools.schema import ArraySchema, StringSchema, tool_parameters_schema
...
from teai_builder.config.paths import get_workspace_path
...
class MessageTool(Tool, ContextAware):
    ...
    async def execute(
        ...
        **kwargs: Any,
        ...
        from teai_builder.utils.helpers import strip_think

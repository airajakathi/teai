...
``teai_builder.session.goal_state.goal_state_runtime_lines``) so compaction cannot hide them.
...
from teai_builder.bus.runtime_events import GoalStateChanged, RuntimeEventBus, RuntimeEventContext

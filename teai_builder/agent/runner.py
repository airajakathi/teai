...
from teai_builder.agent.hook import AgentHook, AgentHookContext, AgentRunHookContext
...
from teai_builder.utils.file_edit_events import (
...
from teai_builder.utils.helpers import (
...
class AgentRunner:
    ...
    async def _request_model(
        ...
        if timeout_s is None:
            ...
            # Set TEAI_BUILDER_LLM_TIMEOUT_S=0 to disable.
            raw = os.environ.get("TEAI_BUILDER_LLM_TIMEOUT_S", "300").strip()
            try:
                timeout_s = float(raw)
        ...
        # (TEAI_BUILDER_STREAM_IDLE_TIMEOUT_S). Do not also apply the outer wall-clock
        # LLM timeout here, or healthy long reasoning streams can be killed just
        # because total elapsed time exceeded TEAI_BUILDER_LLM_TIMEOUT_S.
